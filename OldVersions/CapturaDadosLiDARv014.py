...
hostname = 'os-122308002238'
lidar_port = 7502
imu_port = 7503
n_seconds = 600 # Tempo de captura em segundos

config = client.SensorConfig()
config.udp_profile_lidar = client.UDPProfileLidar.PROFILE_LIDAR_RNG19_RFL8_SIG16_NIR16  # ✅ Compatível com 1024x20
config.lidar_mode = client.LidarMode.MODE_1024x20  # ✅ Resolução maior
...
with closing(client.SensorPacketSource([(hostname, config)], buf_size=640).single_source(0)) as source:
